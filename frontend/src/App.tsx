  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-indigo-50">
      ...
      <header className="sticky top-0 z-40 border-b border-slate-200/40 bg-white/80 backdrop-blur-xl shadow-sm shadow-slate-200/20">
        {/* Row 1: logo + titre + desktop actions */}
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 sm:px-6 py-2.5">
          ...
          <div className="hidden md:flex items-center gap-2 shrink-0">
            ...
            <button
              ...
              className="group flex items-center gap-1.5 rounded-lg border border-slate-200/80 bg-white/60 px-3 py-1.5 text-sm font-medium text-slate-500 shadow-sm transition-all hover:border-indigo-300 hover:text-indigo-600 hover:bg-indigo-50/40"
            >
            ...
            <button
              ...
              className="group flex items-center gap-1.5 rounded-lg bg-gradient-to-r from-violet-500 to-indigo-600 px-3.5 py-1.5 text-sm font-medium text-white shadow-md shadow-indigo-200/50 transition-all hover:shadow-lg hover:shadow-indigo-300/50 hover:scale-[1.02] active:scale-[0.98]"
            >
              <svg className="h-3.5 w-3.5 transition-transform group-hover:scale-110" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 4v16m8-8H4" />
              </svg>
        ...
        {/* Row 2: mobile buttons — full width with text */}
        <div className="md:hidden flex items-center gap-2 px-4 pb-2.5">
          <button
            onClick={() => setShowNewSession(true)}
            className="group flex flex-1 items-center justify-center gap-2 rounded-lg border border-slate-200/80 bg-white/60 px-3 py-2 text-sm font-medium text-slate-500 shadow-sm transition-all hover:border-indigo-300 hover:text-indigo-600 hover:bg-indigo-50/40"
          >
          ...
          <button
            onClick={() => setShowNewTask(true)}
            className="group flex flex-1 items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-violet-500 to-indigo-600 px-3 py-2 text-sm font-medium text-white shadow-md shadow-indigo-200/50 transition-all hover:shadow-lg hover:shadow-indigo-300/50 active:scale-[0.98]"
          >
            <svg className="h-4 w-4 transition-transform group-hover:scale-110" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M12 4v16m8-8H4" />
            </svg>
